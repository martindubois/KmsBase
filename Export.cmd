...
xcopy /IKQS Debug_DLL\*.lib							"%DST%\Libraries\Debug_32_DLL"
xcopy /IKQS Includes\*.h							"%DST%\Includes"
xcopy /IKQS Release\*.lib							"%DST%\Libraries\Release_32"
xcopy /IKQS Release_DLL\*.lib						"%DST%\Libraries\Release_32_DLL"
xcopy /IKQS Scripts\*.cmd							"%DST%"
rem  TODO : xcopy /IKQS Templates\DLL\*.cpp				"%DST%\Templates\DLL"
rem  TODO : xcopy /IKQS Templates\DLL\*.h				"%DST%\Templates\DLL"
rem  TODO : xcopy /IKQS Templates\DLL\_DocUser\*.txt	"%DST%\Templates\DLL\_DocUser"
...
xcopy /IKQS x64\Debug_DLL\*.lib						"%DST%\Libraries\Debug_64_DLL"
xcopy /IKQS x64\Release\*.lib						"%DST%\Libraries\Release_64"
xcopy /IKQS x64\Release_DLL\*.lib					"%DST%\Libraries\Release_64_DLL"
