...
rem Product   KmsBase
rem File      KmsBase_Export_Signed.cmd

echo Executing  Scripts\KmsBase_Export_Signed.cmd %1 %2 %3  ...
...
if ""=="%VERSION_TYPE%" (
    set DST="%EXPORT_FOLDER%\%VERSION_MMB%_Windows_Signed"
) else (
    set DST="%EXPORT_FOLDER%\%VERSION_MMB%_%VERSION_TYPE%_Windows_Signed"
)
...
if ""=="%1" (
    ...
    echo Usage  Scripts\KmsBase_Export_Signed.cmd {Product} {Ma.Mi.Bu} [Type]
    pause
    exit /B 10
)
